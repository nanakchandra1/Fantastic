...
- (void)setupUI
{
    ...
    [self setBackgroundColor:[UIColor colorWithRed:(247.0f/255.0f) green:(0.0f/255.0f) blue:(47.0f/255.0f) alpha:1.0f]];
    ...
    [self.onBackgroundView setBackgroundColor:[UIColor colorWithRed:(247.0f/255.0f) green:(0.0f/255.0f) blue:(47.0f/255.0f) alpha:1.0f]];
    ...
    //[self.offBackgroundView setBackgroundColor:[UIColor colorWithRed:(19.0f/255.0f) green:(121.0f/255.0f) blue:(208.0f/255.0f) alpha:1.0f]];
    [self.onBackgroundView setBackgroundColor:[UIColor colorWithRed:(247.0f/255.0f) green:(0.0f/255.0f) blue:(47.0f/255.0f) alpha:1.0f]];
