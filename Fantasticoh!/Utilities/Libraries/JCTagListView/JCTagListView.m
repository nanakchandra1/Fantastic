...
- (void)setup
{
    ...
    _tagTextColor = [UIColor colorWithRed:163/255.0 green:163/255.0 blue:163/255.0 alpha:1];//[UIColor redColor];
    _tagSelectedTextColor = [UIColor redColor];
    _tagSelectedBackgroundColor = [UIColor clearColor];//[UIColor colorWithRed:217/255.0f green:217/255.0f blue:217/255.0f alpha:1];
    ...
    [layout setSectionInset:UIEdgeInsetsMake(0, 5, 0, 5)]; // nitin
    [layout setMinimumLineSpacing:4]; // nitin
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return CGSizeMake(frame.size.width + 15.0f, frame.size.height + 8); // nitin
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //cell.titleLabel.attributedText = self.tags[indexPath.item];
